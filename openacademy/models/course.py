...
class Session(models.Model):
    ...
    is_student_registered = fields.Boolean(compute="is_registered")

    # is_student = fields.Boolean(compute="get_is_student")

    # def get_is_student(self):
    #     if self.user_has_groups('openacademy.group_academy_student'):
    #         self.is_student = True
    #     else:
    #         self.is_student = False

    def is_registered(self):
        self.is_student_registered = self.env.user.partner_id in [a for a in self.attendee_ids]
    ...
    def register(self):
        ...
        self.sudo().attendee_ids |= self.env.user.partner_id
